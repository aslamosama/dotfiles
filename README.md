...
- **OS** = Arch Linux
- **Login Manager** = None
- **WM** = [dwm](https://github.com/aslamosama/dwm)
- **Bar** = [dwmblocks](https://github.com/aslamosama/dwmblocks)
...
- **Editor** = [Neovim](https://github.com/aslamosama/nvim-config)
...
- **Menu** = [dmenu](https://github.com/aslamosama/dmenu)
